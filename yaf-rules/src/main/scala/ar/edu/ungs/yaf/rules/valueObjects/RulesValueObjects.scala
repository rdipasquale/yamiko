...
object RulesBinValueObjects {

  val genCondicionACampo:Gene=new BasicGene("Condicion A - Campo", 0, 8);
	val genCondicionANeg:Gene=new BasicGene("Condicion A - Neg", 8, 1);
	val genCondicionBPresente:Gene=new BasicGene("Condicion B - Presente", 9, 1);
	val genCondicionBCampo:Gene=new BasicGene("Condicion B - Campo", 10, 8);
	val genCondicionBNeg:Gene=new BasicGene("Condicion B - Neg", 18, 1);
	val genCondicionCPresente:Gene=new BasicGene("Condicion C - Presente", 19, 1);
	val genCondicionCCampo:Gene=new BasicGene("Condicion C - Campo", 20, 8);
	val genCondicionCNeg:Gene=new BasicGene("Condicion C - Neg", 28, 1);
	val genPrediccionCampo:Gene=new BasicGene("Prediccion - Campo", 29, 8);
	val genPrediccionValor:Gene=new BasicGene("Prediccion- Neg", 37, 1);
