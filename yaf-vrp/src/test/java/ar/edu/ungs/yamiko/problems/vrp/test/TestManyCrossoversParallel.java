...
public class TestManyCrossoversParallel {
	 ...
	 */
	@Test
	public void testManyCrossoversParallelUlysses22x4() {
		...
		Parameter<Integer[]> par=	new Parameter<Integer[]>(0.035, 0.96, 100, new DescendantAcceptEvaluator<Integer[]>(), 
								...
								new GlobalSingleSparkPopulation<Integer[]>(genome), 100, 99900.12089781271,rma,genome);
