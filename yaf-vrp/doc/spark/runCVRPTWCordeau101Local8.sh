...
/home/ricardo/cluster/spark-1.3.1-bin-hadoop2.6/bin/spark-submit --class ar.edu.ungs.yamiko.problems.vrp.problems.CVRPTWCordeau101Parallel --master local[8] --jars \
